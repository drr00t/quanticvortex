...
#ifndef __INPUT_EVENT_HANDLER_IRRLICHT_H_
#define __INPUT_EVENT_HANDLER_IRRLICHT_H_
...
namespace input
{
	...
	class InputEventHandlerIrrlicht : public IInputReceiver
        {
		...
		public:
			...
			virtual ~InputEventHandlerIrrlicht(void)   {}
